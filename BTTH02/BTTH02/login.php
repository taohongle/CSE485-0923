                ...
                <form action="process_login.php" class="" method="post">
                    ...
                    <div class="text-center mt-5" style="border-top:1px solid black">
                        <p>Don't have an account?
                            <span><a href="dangky.php" class="text-warning text-decoration-none">Sign up</span></a>
                            <br> <a href="quenMK.php" class="text-warning text-center text-decoration-none">Forgot your password?</a>
                        </p>
